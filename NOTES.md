...
- Multiplicating intervals over the integers produces wrong results with GNU-Prolog v1.5.0, see [issue #28](https://github.com/mlliarm/ia/issues/28). SWI-Prolog v8.5.5-3-gb856d332c-DIRTY doesn't face this limitation.
...
5. S. P. Shary,  Finite Dimensional Interval Analysis (Kонечномерный Интервальный Анализ), 2021, ([PDF, 5.2MB](http://www.nsc.ru/interval/Library/InteBooks/SharyBook.pdf)).
